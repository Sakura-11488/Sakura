...
const episodeInputs: TwoHeEpisodeInput[] = [
    ...
    },
    {
        ...
        title: "NEET",
        description:
            "Trapped between rent day and the algorithm, a chronically online shut-in discovers that staying in your room forever is harder when the entire internet is trying to monetize your despair.",
    },
    {
        slug: "trillionaire",
        file: "trillionaire.mov",
        title: "Trillionaire",
        description:
            "When overnight wealth turns ordinary life into a surreal flex war, one creator chases trillionaire status through hype, chaos, and the kind of AI anime spectacle only the trenches could produce.",
    },
];
