...
/** Explicit confirmation for transfers and other non-destructive actions. */
export function confirmAction(title: string, message: string, actionLabel: string): Promise<boolean> {
